def generate_attributes(dict_cases, list_attgenerators, sample_size=-1):
    '''
    ...
    :return:
    '''
    if not dict_cases or not list_attgenerators:
    ...
    for case_keys, case_data in dict_cases.items():
        for generator in list_attgenerators:
            case_data.add_attribute(generator.get_attr_id(), generator.get_attr(case_data.get_text(sample_size)))
